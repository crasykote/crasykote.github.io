...
// Створити під кожен елемент окремий блок. В цьому блоці, під кожну властивість, та властивості внутрішніх об'єктів створити свої окремі блок.
    ...
    for (const user of usersList) {
        ...
        emailElement.append(user.email);
            ...
            let addressElement = document.createElement('div');
                ...
                addressElement.appendChild(geoElement);
                    ...
                    latElement.append(user.address.geo.lat);
                    geoElement.appendChild(latElement);

                    let lngElement = document.createElement('div');
                    lngElement.append(user.address.geo.lng);
        ...
        Block.appendChild(usernameElement);
        Block.appendChild(emailElement);
        Block.appendChild(addressElement);
        Block.appendChild(phoneElement);
        Block.appendChild(websiteElement);
        Block.appendChild(companyElement);
